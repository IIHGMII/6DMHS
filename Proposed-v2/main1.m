...
% -10：1：10
% LoS
% [3.226065343200174e-04  3.811842585191445e-04  4.642319802173562e-04  5.545533170160646e-04  6.575732525575083e-04 7.757031556965254e-04  9.078141086695302e-04 0.001034595549463  0.001206975444288  0.001367305459843  0.001533349409708  0.001696753260016 0.001854670792693  0.001936855975658  0.002143800359037   0.002266227565356 0.002279309559373  0.002469370901226    0.002550976400411   0.002547547036898  0.002667241641142];
% Pro
% [0.002365274179475        0.002140288608120        0.001816893891279        0.001920155186775        0.001750880632598        0.001872502691983        0.002294511735511        0.002351256789119  0.002377365245245  0.002407916588221  0.002403668933715  0.002483362520877 0.002623349806705  0.002631803247172  0.002642215415601   0.002629374940744  0.002617240740587  0.002617960001207   0.002626385009646   0.002636578267218  0.002672213272791];
% Perhaps
% P_EH =  [0.003883532318133  0.004037102930396   0.004111640459800  0.004296004997514  0.004448984031314  0.004681456003671  0.004828296576436 0.004841066761504 ]

%Perfect
% [0.002860773687145  0.003322697624521  0.003020435060322]
...
for ITE_NUM = 1:5
    ...
    Gain_Beam_Fair_ITE(1) = Gain_Beam_Fair;
    Gain_Beam_Fair_old = Gain_Beam_Fair;
    time1 = 0;
    time2 = 0;
    %没有在每次迭代完更新导向矢量
            ...
            for b = 1:B
                ...
                if sum(C_set{b} == b1) >= 1
                    ...
                    for k0 = 1:K
                        ...
                        mm1 = sparse(diag(m_temp(:, 1)));
                        mm2 = sparse(diag(m_temp(:, 2)));
                        mm3 = sparse(diag(m_temp(:, 3)));
                        mm4 = sparse(diag(m_temp(:, 4)));
