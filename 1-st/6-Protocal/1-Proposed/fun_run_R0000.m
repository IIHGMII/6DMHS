function [fun_out] = fun_run_R0000( R00 , H_eff , rho , psi1 , psi2 , sigma0 , Ptx , B , K ,Q , M , H , A_ST , V_F , Xtr , eta0 )
...
variable mm(M,B) 
variable P0(1)
expressions mm_temp1(M,K,B)  R_temp(K,K) R_thro(K,1) R_temp0(K,1) H_eff(B*Q,K) P_temp(K,K) P_EH(K,1)
