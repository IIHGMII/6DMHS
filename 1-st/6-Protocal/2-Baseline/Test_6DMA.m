...
% 初始化优化参数
norm_coff = 1;
psi1 = 0.5 * randn(K,K) + 0.5j * randn(K,K);   psi2 = 0.01 * rand(K,1) + 0.01j * rand(K,1) ;
...
%     psi2 = psi2_fixed;
    ...
    [P_ave(iiiii)] = fun_run_R00( R00 , H_eff , rho , psi1 , psi2_fixed , sigma0 , Ptx , B , K , Q );
