function [ek, error_ben1] = Benchmark_Sensing(B,M,K,V_F,h,lambda,eta0,delta_x,Mx,Coor_Ele,e0,N)
...
%         PRHS(i1,j1) = ( mm(:,1).' * V_F000 * aa{1}(theta0,phi0) )' * mm(:,1).' * V_F000 * h{k,1} + ( mm(:,2).' * V_F000 * aa{2}(theta0,phi0) )' * mm(:,2).' * V_F000 * h{k,2} + ( mm(:,3).' * V_F000 * aa{3}(theta0,phi0) )' * mm(:,3).' * V_F000 * h{k,3} + ( mm(:,4).' * V_F000 * aa{4}(theta0,phi0) )' * mm(:,4).' * V_F000 * h{k,4} + ( mm(:,5).' * V_F000 * aa{5}(theta0,phi0) )' * mm(:,5).' * V_F000 * h{k,5}  ;
        PRHS(i1,j1) = ( mm(:,1).' * V_F000 * aa{1}(theta0,phi0) )' * mm(:,1).' * V_F000 * h{k,1} + ( mm(:,2).' * V_F000 * aa{2}(theta0,phi0) )' * mm(:,2).' * V_F000 * h{k,2} + ( mm(:,3).' * V_F000 * aa{3}(theta0,phi0) )' * mm(:,3).' * V_F000 * h{k,3} + ( mm(:,4).' * V_F000 * aa{4}(theta0,phi0) )' * mm(:,4).' * V_F000 * h{k,4} ;
...
ek(:,k) = angle_R{index1,index2};


end

error_ben1(k,1) = norm( ek(:,k) - e0{k} , 2 )
