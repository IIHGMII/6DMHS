function [Coor_Ele,normal_vector,Rot_Matrix,q,Coor_Ele_x,Coor_Ele_y,Coor_Ele_x_d,Coor_Ele_x_u,Coor_Ele_y_l,Coor_Ele_y_r] = Orientation_Initial(B,Coor_Ele_init,Coor_Ele_init_r,Coor_Ele_init_c,flag,Coor_Ele_init_x_d , Coor_Ele_init_x_u , Coor_Ele_init_y_l , Coor_Ele_init_y_r)
...
for b = 1:B
    ...
    if norm(n2-n1) <= 1e-3
        ...
        Coor_Ele_x_d{b} = q(b,:) + Coor_Ele_init_x_d;
        Coor_Ele_x_u{b} = q(b,:) + Coor_Ele_init_x_u;
        Coor_Ele_y_l{b} = q(b,:) + Coor_Ele_init_y_l;
        Coor_Ele_y_r{b} = q(b,:) + Coor_Ele_init_y_r;
        normal_vector{b} = q(b,:).';
        Rot_Matrix{b} = eye(3);
        am2{b} = Rot_Matrix{b} * am1;
    elseif norm(n2+n1) <= 1e-3
    ...
    Coor_Ele_x_d{b} = q(b,:) + Coor_Ele_init_x_d * Rot_Matrix{b}.';
    Coor_Ele_x_u{b} = q(b,:) + Coor_Ele_init_x_u * Rot_Matrix{b}.';
    Coor_Ele_y_l{b} = q(b,:) + Coor_Ele_init_y_l * Rot_Matrix{b}.';
    Coor_Ele_y_r{b} = q(b,:) + Coor_Ele_init_y_r * Rot_Matrix{b}.';
    normal_vector{b} = q(b,:).'; 
    am2{b} = Rot_Matrix{b} * am1;
